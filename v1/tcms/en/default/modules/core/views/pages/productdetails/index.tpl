                                ...
                                {foreach item = data  from = $product_details}
                                    <tr>
                                        <td class="text-align-center">
                                            <label><input type="checkbox" id="productdetails-select" class="check_box" data-id="{$data.id}" data-prd-detls-item="{$data.itemId}" data-prd-detls-brand="{$data.brandId}" data-modelNumber="{$data.model}" data-serialNumber="{$data.serial}" data-unitPrice="{$data.price}" data-warrantyTime="{$data.warrenty}" data-ability="{$data.ability}"/></label>
                                        </td>
