...
class InvoiceManager extends Mishusoft {
    constructor() {
        super();
        this.AllClientsURL = this.AppHostAddress + 'clients/getClientsOrderByName';
        this.AllItemsURL = this.AppHostAddress + 'items/getAvailableItemsOrderByName';
    ...
    saveClients() {
        ...
        ajax.open("POST", _root_ + 'clients/addClients', true);
    ...
    viewItemsForInvoices() {
        ...
        this.ajax.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                ...
                this.html = '';
                this.html += '<option value=""> -- Select One --</option>';
                this.html += '<option value="addNew" id="inv-prd-item-add-btn"> New Item </option>';
    ...
    vefifyIsBrandAlreadyExists() {
        ...
        ajaxB.open("POST", _root_ + 'brands/isBrandAlreadyExists', true);
    ...
    viewSoldItemsByInvId() {
        ...
        if (Mishusoft.isNumber(invoiceNumber)) {
            ...
            let ajax = new XMLHttpRequest();
            ajax.open('POST', _root_ + 'invoices/getSoldItemsByInvId', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
                ...
                if (this.readyState === 4 && this.status === 200) {
                    ...
                    if (data2.length !== 0) {
                        ...
                        for (let a = 0; a < data2.length; a++) {
                            ...
                            let warrentyTime = data2[a].warrentyTime;
                            ...
                            html += 'Warranty:&nbsp;' + warrentyTime + '&nbsp;days';
                            html += '</td>';
                        ...
                        //update total bill
                        myApp.manageBillMoney('update', sumOfTotalPrice);
    ...
    manageBillMoney(mode, sumOfTotalPrice) {
        let dataBill = {
            security_code : 1,
        ...
        ajaxBill.open("POST", _root_ + 'invoices/manageBill', true);
    ...
    viewBrandByItemId(InvPrdItmId){
        if (Mishusoft.isNumber(InvPrdItmId)) {
            let data = '';
            data = {security_code : 1, id : InvPrdItmId};

            let ajax = new XMLHttpRequest();
            ajax.open("POST", _root_ + 'productdetails/getBrandByItemId', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
    ...
    viewModelByItemBrand(InvPrdItmId,InvPrdBrdId){
        if (Mishusoft.isNumber(InvPrdBrdId)) {
            let data = '';
            data = {security_code : 1, item : InvPrdItmId, brand : InvPrdBrdId};

            let ajax = new XMLHttpRequest();
            ajax.open("POST", _root_ + 'productdetails/getModelByItemBrandId', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
    ...
    printInvoice(id) {
        Mishusoft.PopUpWindowCenterPosition(_root_ + 'invoices/doprint/' + id, 'Invoice no: ' + id, '700', '500');
    }
...
$('#invoices-data-table').on('click', '.page', function () {
    let url = 'invoices/invoicesPaginationAJAX';
...
$(document).on('change', '#clnt_fl_nm', function () {
    ...
    if (Mishusoft.isNumber(clntId)) {
        ...
        let data = '';
        data = {security_code : 1, id : clntId};

        let ajax = new XMLHttpRequest();
        ajax.open("POST", _root_ + 'clients/getSelectedClient', true);
        ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
        ajax.send(JSON.stringify(data)); // Make sure to stringify
...
$(document).on('change', '#inv-prd-brand', function () {
    if (Mishusoft.detectElement('inv-prd-brand').value === 'addNew') {
        ...
        myApp.viewModelByItemBrand(Mishusoft.detectElement('inv-prd-item').value,Mishusoft.detectElement('inv-prd-brand').value);
    }
});
    ...
    if (Mishusoft.detectElement('brand-data-btn').innerHTML === 'Save') {
        ...
        ajax.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                ...
                myApp.vefifyIsBrandAlreadyExists();
            }
        };
    }
...
$(document).on('change', '#inv-prd-modelNumber', function () {
    if (Mishusoft.detectElement('inv-prd-modelNumber').value !== '') {
        ...
        let data = '';
        data = {security_code : 1, item : InvPrdItmId, brand : InvPrdBrdId, model : InvPrdMdlNm};

        let ajax = new XMLHttpRequest();
        ajax.open("POST", _root_ + 'productdetails/getDetailsByItemBrandModelName', true);
        ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
        ajax.send(JSON.stringify(data)); // Make sure to stringify
        //receiving response from ajax
        ajax.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                ...
                if (data.length !== 0) {
                    ...
                    for (let a = 0; a < data.length; a++) {
                        ...
                        let warrantyTime = data[a].warrenty;
...
$(document).on('click', '#cart-add-btn', function () {
    ...
    if (data !== '') {
        let ajax = new XMLHttpRequest();
        ajax.open("POST", _root_ + 'invoices/addToCart', true);
        ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
        ajax.send(JSON.stringify(data)); // Make sure to stringify
        //receiving response from ajax
        ajax.onreadystatechange = function () {
...
$(document).on('click', '#sld-itm-edit-btn', function () {
    ...
    //myApp.viewModelByItemBrand($(this).attr('data-itemid'),$(this).attr('data-brandid'));
    //Mishusoft.detectElement('inv-prd-brand').value = $(this).attr('data-brandid');
    //Mishusoft.detectElement('inv-prd-modelNumber').value = $(this).attr('data-model');
...
$(document).on('click', '#sld-itm-delete-btn', function () {
    ...
    $(document).on('click', '#message-done-btn', function () {
        if (commandBtn === 'Delete') {
            ...
            let ajax = new XMLHttpRequest();
            ajax.open("POST", _root_ + 'invoices/deleteSoldItem', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
...
$(document).on('click', '#invoice-data-btn', function () {
    ...
    if (command === 'Save') {
        ...
        myApp.printInvoice(Mishusoft.detectElement('invoiceID').value);
    }


    let ajax = new XMLHttpRequest();
    ajax.open("POST", _root_ + 'invoices/addInvoice', true);
    ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
    ajax.send(JSON.stringify(data)); // Make sure to stringify
    //receiving response from ajax
    ajax.onreadystatechange = function () {
            ...
            if (Mishusoft.IsJsonString(this.responseText)) {
                ...
                for (let a = 0; a < d.length; a++) {
                    ...
                    if (type === "success") {
                        ...
                        Mishusoft.detectElement('invoiceEditMode').innerHTML = 'Invoice no:&nbsp;' + inv_id;
                    ...
                    if (ElementId) {
                        ...
                        myApp.viewSoldItemsByInvId();
                        myApp.manageBillMoney('create',0);
                    }
                }
            }
            else {
...
$(document).on('click', '#popup-invoice-print-btn', function () {
    myApp.printInvoice($(this).attr('data-id'));
});
//print invoice
...
$(document).on('click', '#invoice-select', function () {
    if (this.checked) {
        Mishusoft.detectElement('message2').innerHTML = '';
        Mishusoft.detectElement('modal01').style.display = 'block';
        Mishusoft.detectElement('invoiceEditMode').innerHTML = 'Invoice no: ' + $(this).attr('data-id');
...
$(document).on('click', '#invoice-delete-btn', function () {
    ...
    $(document).on('click', '#message-done-btn', function () {
        if (commandBtn === 'Delete') {
            ...
            let ajax = new XMLHttpRequest();
            ajax.open("POST", _root_ + 'invoices/deleteInvoice', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
