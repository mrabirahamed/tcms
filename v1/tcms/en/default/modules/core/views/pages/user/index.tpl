...
<div class="row">
    <div class="userProfileCover">
        ...
        <div class="userFullName">
            <a href="{$layoutParams.root}user/profile/{preg_replace('/msu_/is', '$1', Session::get('username'))}">{$user.f_name}&nbsp;{$user.l_name}</a>
        </div>
    ...
    <div class="col-lg-plus-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-xs-plus-12">
        ...
        <div class="col-lg-plus-8 col-lg-8 col-md-9 col-sm-12 col-xs-12 col-xs-plus-12">
            ...
            <div class="col-lg-plus-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-xs-plus-12 OLDPost UserAreaShadow">
                ...
                <p>Terabyte (TB) is a digital information measurement unit which is going to be extensively used in the nearest future for measuring the size of computer RAM, etc., but now it is used for measuring the amount of digital information in online libraries, digital archives, and so on. 1 terabyte is equal to 1000 gigabytes, or 1012 bytes. However, in terms of information technology or computer science, 1 TB is 240 or 10244 bytes, which is equal to 1,099,511,627,776 bytes.</p>
            </div>
        </div>
    </div>
</div>
