...
(
  ...
  `slditmWarrentyTime`        int(11)      NOT NULL,
...
VALUES ('Home', 'Home', '', 'fas fa-home', 'header', ''),
       ('Products', 'Products', 'products', 'fab fa-app-store', 'header', '');
...
VALUES (null, 'Super User', 'root_access', 'PKRTACSS'),
       ...
       (null, 'Get Clients Invoive', 'get_clients_invoice', 'PKGTCLIN'),
       ...
       (null, 'Edit Clients Invoive', 'edit_clients_invoice', 'PKEDCLIN'),
       (null, 'Delete Clients Invoive', 'delete_clients_invoice', 'PKDLCLIN'),
...
--
-- Table structure for table `{DB_PREFIX}site_info`
--

CREATE TABLE IF NOT EXISTS `{DB_PREFIX}siteInfo`
(
  `id`             int(10)      NOT NULL AUTO_INCREMENT,
  `name`           varchar(50)  NOT NULL,
  `description`    varchar(100) DEFAULT NULL,
  `company`        varchar(50)  NOT NULL,
  `doc_root`       varchar(50)  NOT NULL,
  `http_host_add`  varchar(60)  NOT NULL,
  `http_host_ip`   varchar(40)  NOT NULL,
  `default_home`   varchar(60)  NOT NULL,
  `default_layout` varchar(50)  NOT NULL,
  `icon_dir`       varchar(100) NOT NULL,
