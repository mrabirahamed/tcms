            ...
            {foreach item = data  from = $brands}
                <tr>
                    <td class="text-align-center">
                        <label><input type="checkbox" id="brand-select" class="check_box" data-id="{$data.id}"
                                      data-name="{$data.name}"/></label>
                    </td>
                    <td class="text-align-center">{$data.serialNumber}</td>
                    <td class="text-align-left">{$data.name}</td>
                    <td class="text-align-center">
                        <a href="javascript:void(0);" id="brand-edit-btn" class="button button-xs button-success"
                           data-id="{$data.id}" data-name="{$data.name}">&nbsp;<i class="far fa-edit"></i></i></a>&nbsp;&nbsp;
                        <a href="javascript:void(0);" id="brand-delete-btn" class="button button-xs button-danger"
