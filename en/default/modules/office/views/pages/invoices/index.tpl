                            ...
                            <div class='modal-body'>
                                ...
                                <div id="invoiceEditPAD">
                                    ...
                                    <form name="form1" id="invoiceForm1" method="post">
                                        ...
                                        <input id="invoiceBranchId" type="hidden" value="{$branch.id}"/>
                                        <input id="invoiceBranchName" type="hidden" value="{$branch.name}"/>
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <table class="table table-condensed">
                                                        <tr>
                                                            ...
                                                            <td style="width: 30%;">
                                                                <label>
                                                                    Salesman:{*<span class="text-danger">(*)</span>*}
                                                                    <input id="sls_mn" type="text" class="input-control"
                                            ...
                                            <fieldset class="box-shadow-light" id="ordered_product_zone">
                                                ...
                                                <div class="row">
                                                    <table class="table table-condensed table-striped table-bordered">
                                                        ...
                                                        <tbody id="ordered_product_total_area"{* style="display: none;"*}>
                                                ...
                                                <td style="width: 25%;">
                                                    ...
                                                    <select id="inv_srh_branch" class="input-control"
                                                        ...
                                                        {if isset($branches) && count($branches)}
                                                            {foreach item = brcs  from = $branches}
                                                                <option value="{$brcs.id}"> {$brcs.name} </option>
                                                            {/foreach}
                                                        {/if}
