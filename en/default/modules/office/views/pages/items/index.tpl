                ...
                <div class="row">
                    ...
                    <div id="item-data-table">
                        <table class="table table-condensed table-striped">
                                ...
                                {foreach item = data  from = $items}
                                    <tr>
                                        <td class="text-align-center">
                                            <label><input type="checkbox" id="item-select" class="check_box"
                                                          data-id="{$data.id}" data-name="{$data.name}"
                                                          data-c_status="{$data.c_status}"/></label>
                                        </td>
                                        <td class="text-align-center">{$data.serialNumber}</td>
                                        <td class="text-align-left">{$data.name}</td>
                                        <td class="text-align-center">
                                            {if ($data.c_status === 'available')}<a href="javascript:void(0)"
                                                        ...
                                                        class="far fa-check-circle"></i></a>{else}<a
                                                href="javascript:void(0)" id="changeItemAbility" data-id="{$data.id}"
                                                data-curent_status="{$data.c_status}"
                                                class="button button-xs button-danger" title="Click to make available">
                                                    <i class="far fa-times-circle"></i></a>{/if}
                                        </td>
                                        <td class="text-align-center">
                                            <a href="javascript:void(0);" id="item-edit-btn"
                                               class="button button-xs button-success" data-id="{$data.id}"
                                               data-name="{$data.name}" data-c_status="{$data.c_status}"><i
                                                        class="far fa-edit"></i></i></a>&nbsp;&nbsp;
                                            <a href="javascript:void(0);" id="item-delete-btn"
                            ...
                            {else}
                                <tr>
                                    <td colspan="5">No brand exist.</td>
                                </tr>
                            {/if}
                            </tbody>
