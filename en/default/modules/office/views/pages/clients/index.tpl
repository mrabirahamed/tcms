                                ...
                                {foreach item = data  from = $clients}
                                    <tr>
                                        <td class="text-align-center">
                                            <label>
                                                <input type="checkbox" id="clients-select" class="check_box"
                                                       data-id="{$data.id}" data-name="{$data.name}"
                                                       data-mobile-number="{$data.mobile_number}"
                                        ...
                                        <td class="text-align-center">
                                            <a href="javascript:void(0);" id="clients-edit-btn"
                                               class="button button-xs button-success" data-id="{$data.id}"
                                               data-name="{$data.name}"
                                               data-mobile-number="{$data.mobile_number}"
                                               data-address="{$data.address}"> <i class="far fa-edit"></i></a>&nbsp;&nbsp;
                                            <a href="javascript:void(0);" id="clients-delete-btn"
