...
class productdetailsController extends officeController
{
    ...
    public function getBranches()
    {
        ...
        echo json_encode($this->productdetails->getBranches());
    }
    ...
    public function getModelByItemBrandId()
    {
        ...
        if (count($data) > 0) {
            ...
            if (empty($data->branch)) {
                echo json_encode([['type' => 'error', 'message' => 'Branch\'s id not found.',],]);
                Tracker::addEvent(array('activity' => array('messageType' => 'error', 'message' => 'Branch\'s id not found.')));
                exit;
            }
            ...
            echo json_encode($this->productdetails->getModelByItemBrandId($this->filterInt($data->branch), $this->filterInt($data->item), $this->filterInt($data->brand)));
        }
    }
    ...
    public function getDetailsByItemBrandModelName()
    {
        ...
        if (count($data) > 0) {
            ...
            echo json_encode($this->productdetails->getDetailsByItemBrandModelName($this->filterInt($data->branch),$this->filterInt($data->item), $this->filterInt($data->brand), $this->getTextnonPOST($data->model)));
        }
    }
    ...
    public function addProductDetail()
    {
        ...
        if (count($data) > 0) {
            ...
            if (empty($data->branch)) {
                echo json_encode([['type' => 'error', 'message' => 'Branch name not found.',],]);
                Tracker::addEvent(array('activity' => array('messageType' => 'error', 'message' => 'Branch name not found.')));
                exit;
            }
            ...
            if ($data->btnName === 'Save') {
                if ($this->productdetails->isProductDetailAlreadyExists($this->filterInt($data->branch), $this->filterInt($data->item), $this->filterInt($data->brand), $this->getTextnonPOST($data->modelNumber), $this->getTextnonPOST($data->serialNumber), $this->filterInt($data->unitPrice), $this->getTextnonPOST($data->ability))) {
