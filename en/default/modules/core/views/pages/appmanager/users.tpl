                            ...
                            {if isset($users) && count($users)}
                                {foreach item = data  from = $users}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-align-center">
                                            {if ($data.profile_picture)}
                                                <img alt="Photo" id="user-picture-change-btn" data-user="{$data.id}"
                                                     src="{$layoutParams.root}appmanager/viewUserCurrentProfilePicture/{$data.id}/{$data.profile_picture}"
                                        ...
                                        <td class="text-align-center">{$data.password}</td>
                                        ...
                                        <td class="text-align-center">
                                            <a href="javascript:void(0);" id="user-edit-btn"
                                               ...
                                               data-profile_picture="{$data.profile_picture}"><i
