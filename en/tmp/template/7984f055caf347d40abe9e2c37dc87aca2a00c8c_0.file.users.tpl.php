<?php
/* Smarty version 3.1.33, created on 2019-05-22 11:27:01
  from '/home/mishusoft/public_html/releases/tcms/en/default/modules/core/views/pages/appmanager/users.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ce4dda52852c8_45552218',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7984f055caf347d40abe9e2c37dc87aca2a00c8c' => 
    array (
      0 => '/home/mishusoft/public_html/releases/tcms/en/default/modules/core/views/pages/appmanager/users.tpl',
      1 => 1557234949,
      2 => 'file',
    ),
  ),
...
function content_5ce4dda52852c8_45552218 (Smarty_Internal_Template $_smarty_tpl) {
                                                    ...
                                                    <div class="text-align-center">
                                                        <label>
                                                            <img alt="Photo" id="profile_picture"
                                                                 src="<?php echo $_smarty_tpl->tpl_vars['layoutParams']->value['publicIMG'];?>
img_avatar3.png"
                                                ...
                                                <td style="width: 35%">
                                                    First Name:
                                                    <input id="userFName" type="text" class="input-control"
                                                           placeholder="First name:" maxlength="30"/>
                                                </td>
                                                <td style="width: 35%">
                                                    Last Name:
                                                    <input id="userLName" type="text" class="input-control"
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 70%;">
                                                    Email:
                                                    <input id="userEmail" type="email" class="input-control"
                                            ...
                                            <tr>
                                                <td style="width: 30%;">
                                                    Username:
                                                    <input id="userUsername" type="text" class="input-control"
                                                           placeholder="Username" maxlength="30" autocomplete="stop"/>
                                                </td>
                                                <td style="width: 35%;">
                                                    Password:
                                                    <input id="userPassword" type="password" class="input-control"
                                        ...
                                        <td class="text-align-center">
                                            <label>
                                                <input type="checkbox" id="user-select" class="check_box"
                                                       data-userID="<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
"
                                                       data-userFName="<?php echo $_smarty_tpl->tpl_vars['data']->value['first_name'];?>
"
                                                       data-userLName="<?php echo $_smarty_tpl->tpl_vars['data']->value['last_name'];?>
"
                                                       data-userEmail="<?php echo $_smarty_tpl->tpl_vars['data']->value['email'];?>
"
                                                       data-userPassword="<?php echo $_smarty_tpl->tpl_vars['data']->value['password'];?>
"
...
"
                                                       data-userRole="<?php echo $_smarty_tpl->tpl_vars['data']->value['roleid'];?>
"/>
                                            </label>
                                        </td>
                                        ...
                                        <td class="text-align-center">
                                            <?php if (($_smarty_tpl->tpl_vars['data']->value['profile_picture'])) {?>
                                                <img alt="Photo" id="user-picture-change-btn" data-user="<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
"
                                                     src="<?php echo $_smarty_tpl->tpl_vars['layoutParams']->value['root'];?>
appmanager/viewUserCurrentProfilePicture/<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
/<?php echo $_smarty_tpl->tpl_vars['data']->value['profile_picture'];?>
"
...
"
                                        ...
                                        <td class="text-align-left"><?php echo $_smarty_tpl->tpl_vars['data']->value['first_name'];?>
</td>
                                        <td class="text-align-left"><?php echo $_smarty_tpl->tpl_vars['data']->value['last_name'];?>
</td>
                                        <td class="text-align-center"><?php echo $_smarty_tpl->tpl_vars['data']->value['email'];?>
</td>
                                        <td class="text-align-center"><?php echo $_smarty_tpl->tpl_vars['data']->value['password'];?>
</td>
                                        ...
                                        <td class="text-align-center">
                                            ...
                                            <?php } else { ?><a href="javascript:void(0)" id="verfyUSER"
                                                     class="button button-xs button-danger" data-userID="<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
"
...
" ><i class="far fa-times-circle"></i>
                                        ...
                                        <td class="text-align-center">
                                            <a href="javascript:void(0);" id="user-edit-btn"
                                               class="button button-xs button-success" data-userID="<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
"
                                               data-userFName="<?php echo $_smarty_tpl->tpl_vars['data']->value['first_name'];?>
" data-userLName="<?php echo $_smarty_tpl->tpl_vars['data']->value['last_name'];?>
"
...
"
                                               data-userPassword="<?php echo $_smarty_tpl->tpl_vars['data']->value['password'];?>
"
                                               data-userUsername="<?php echo strtolower($_smarty_tpl->tpl_vars['data']->value['username']);?>
"
                                               data-userActivity="<?php echo $_smarty_tpl->tpl_vars['data']->value['activity'];?>
" data-userRole="<?php echo $_smarty_tpl->tpl_vars['data']->value['roleid'];?>
"
                                               data-gender="<?php echo $_smarty_tpl->tpl_vars['data']->value['gender'];?>
" data-dob="<?php echo $_smarty_tpl->tpl_vars['data']->value['date_of_birth'];?>
"
                                               data-profession="<?php echo $_smarty_tpl->tpl_vars['data']->value['profession'];?>
"
                                               data-profile_picture="<?php echo $_smarty_tpl->tpl_vars['data']->value['profile_picture'];?>
"><i
